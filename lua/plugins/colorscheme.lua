return {
    {
        ...
        opts = {
            ...
            styles = {
                comments = { italic = false }, -- 斜体注释
                keywords = { italic = false }, -- 斜体关键字
                functions = { bold = false },  -- 粗体函数名
                variables = {},
                -- sidebars = "transparent",                                  -- 侧边栏透明
                -- floats = "transparent",                                    -- 浮动窗口透明
            },
            sidebars = { "qf", "help", "terminal", "packer", "neo-tree" }, -- 需要特殊样式的侧边栏
            night_brightness = 1,                                          -- light 样式亮度调整
            ...
            on_highlights = function(highlights, colors)
                ...
                -- highlights.String = { fg = colors.purple, bold = false }
                -- highlights.Variable = { fg = colors.red, bold = false }
            end,
        },
